...
for( $o = 1; $o <= 12; $o++ ) { 
 if ($o < 10)   
 {   
fwrite($file,"<event><id>".++$id."</id><name>Reboot SQL</name><startdate>".$year."-0".$o."-22</startdate><enddate></enddate><starttime></starttime><endtime></endtime><color>#9b59b6</color></event>\n");   }

 else {
fwrite($file,"<event><id>".++$id."</id><name>Reboot SQL</name><startdate>".$year."-".$o."-22</startdate><enddate></enddate><starttime></starttime><endtime></endtime><color>#9b59b6</color></event>\n");   }	 
 }
 
 for( $p = 1; $p <= 12; $p++ ) { 
 if ($p < 10)   
 {   
fwrite($file,"<event><id>".++$id."</id><name>LIA</name><startdate>".$year."-0".$p."-02</startdate><enddate></enddate><starttime></starttime><endtime></endtime><color>#16a085</color></event>\n");   }

 else {
fwrite($file,"<event><id>".++$id."</id><name>LIA</name><startdate>".$year."-".$p."-02</startdate><enddate></enddate><starttime></starttime><endtime></endtime><color>#16a085</color></event>\n");   }	 
 }
 
 for( $q = 1; $q <= 12; $q++ ) { 
 if ($q < 10)   
 {   
fwrite($file,"<event><id>".++$id."</id><name>Revalo</name><startdate>".$year."-0".$q."-01</startdate><enddate></enddate><starttime></starttime><endtime></endtime><color>#16a085</color></event>\n");   }

 else {
fwrite($file,"<event><id>".++$id."</id><name>Revalo</name><startdate>".$year."-".$q."-01</startdate><enddate></enddate><starttime></starttime><endtime></endtime><color>#16a085</color></event>\n");   }	 
 }
